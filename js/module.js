...
(function() {
  ...
  NativeModule = {
    names: ["assert", "buffer", "buffer_ieee754", "child_process", "cluster", "console", "constants", "crypto", "dgram", "dns", "domain", "events", "freelist", "fs", "http", "https", "module", "net", "os", "path", "punycode", "querystring", "readline", "repl", "stream", "string_decoder", "sys", "timers", "tls", "tty", "url", "util", "vm", "zlib"],
    require: function(path) {
      return require(path);
    },
    exists: function(path) {
      return __indexOf.call(NativeModule.names, path) >= 0;
    }
  };
...
;
  ...
  Module._isNative = function(request) {
    return NativeModule.exists(request);
  };
